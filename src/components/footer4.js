        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="footer4-text19">Link 1</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer4-text14">Link 2</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer4-text17">Link 4</span>
                </Fragment>
              )}
            </a>
            <a
          ...
          <div className="footer4-row">
            ...
            <div className="footer4-footer-links">
              ...
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer4-text16">Cookies Settings</span>
                  </Fragment>
                )}
              </span>
            </div>
