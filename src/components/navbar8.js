          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-filled thq-button-animated">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text16">View Home</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text18">Contact Us</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text22">Services</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text23">Contact Us</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  page1ImageSrc:
    'https://images.unsplash.com/photo-1557256728-cd9dbea73286?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Nzk2NDU5MHw&ixlib=rb-4.1.0&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1554570586-96e25dc13be5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Nzk2NDU5MHw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  action1: undefined,
  page4ImageAlt: 'Contact icon',
  link3: undefined,
  action2: undefined,
  page3ImageAlt: 'Team working together on a project',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1517176244227-8c9272cb93c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Nzk2NDU5MXw&ixlib=rb-4.1.0&q=80&w=1080',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1532202802379-df93d543bac3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Nzk2NDU5MHw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  page2ImageAlt: 'Illustration of various safety equipment',
  link4: undefined,
  page3: undefined,
  logoAlt: 'Company logo',
  link1: undefined,
  page1ImageAlt: 'Image of a safe working at heights',
