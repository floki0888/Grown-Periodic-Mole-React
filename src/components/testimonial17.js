      ...
      <div className="testimonial17-max-width thq-section-max-width">
        <div className="testimonial17-container10">
          <h2 className="thq-heading-2">
            {props.heading1 ?? (
              <Fragment>
                <span className="testimonial17-text25">Customer Feedback</span>
              </Fragment>
            )}
          </h2>
                  ...
                  {props.review1 ?? (
                    <Fragment>
                      <span className="testimonial17-text32">
                        Great service and attention to detail. The team at
                        Height Safety Co. ensured our project was completed
                  ...
                  {props.review2 ?? (
                    <Fragment>
                      <span className="testimonial17-text33">
                        Professional and reliable company. Their expertise in
                        height safety systems made a significant difference in
                  ...
                  {props.review3 ?? (
                    <Fragment>
                      <span className="testimonial17-text35">
                        Impressed with the quality of work and dedication shown
                        by Height Safety Co. Would highly recommend their
                        services.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.review4 ?? (
                    <Fragment>
                      <span className="testimonial17-text34">
                        Exceptional customer service and top-notch safety
                        solutions. Height Safety Co. exceeded our expectations.
                      </span>
                    </Fragment>
                  )}
                </span>
