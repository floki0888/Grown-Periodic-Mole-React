        ...
        <div className="contact10-content3 thq-flex-row">
          <div className="contact10-container2">
            ...
            <h3 className="contact10-text12 thq-heading-3">
              {props.location1 ?? (
                <Fragment>
                  <span className="contact10-text19">Sydney Office</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
          ...
          <div className="contact10-container4">
            ...
            <h3 className="contact10-text14 thq-heading-3">
              {props.location2 ?? (
                <Fragment>
                  <span className="contact10-text17">Melbourne Office</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
...
Contact10.defaultProps = {
  ...
  location1: undefined,
  content1: undefined,
  location2ImageAlt: 'Melbourne Office Image',
  heading1: undefined,
  location1ImageAlt: 'Sydney Office Image',
  location1ImageSrc:
