          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Initial Consultation</span>
                  </Fragment>
                )}
              </h2>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text28">Customized Solution</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      We tailor a height safety system that fits your specific
                      needs and budget.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Our experienced team installs the height safety system
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Comprehensive Testing</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      We conduct thorough testing to ensure the system meets all
                      safety standards.
                    </span>
                  </Fragment>
                )}
